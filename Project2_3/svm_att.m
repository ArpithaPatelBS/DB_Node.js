z= 5;
input=KFOLD(z, 'F:\Spring 2016\Data Mining\Data Mining Project 2\Data Mining Project2_3 final\svm\ATnTDataSet.txt')
%input=KFOLD_HandWritten('F:\Spring 2016\Data Mining\Data Mining Project 2\HandWrittenLetters.txt')
acc = rand(1,z);
for m=1:z
    m
...
for k=1:numLabels
    model{k} = svmtrain(double(TL==k), TRAIN, '-t 0 -c 1 -g 1 -b 1');

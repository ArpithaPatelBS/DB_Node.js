function [ output_args ] = KFOLD( k, Xtrain, Ytrain, z )
...
%   Detailed explanation goes here
    ...
    for m = 1:k
        OutPutMatrix(1,m) = mat2cell(rand( 40 * (10 - floor(10/k)), z), [40 * (10 - floor(10/k))],[z]);
        OutPutMatrix(2,m) = mat2cell(rand(40 * (floor(10/k)), z), [40 * (floor(10/k))],[z]);
    end
